...
type OrderServiceClient interface {
	...
	ListOrders(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListOrderResponse, error)
}
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListOrderResponse, error) {
...
type OrderServiceServer interface {
	...
	ListOrders(context.Context, *Empty) (*ListOrderResponse, error)
...
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *Empty) (*ListOrderResponse, error) {
